...
def send_organizer_notification(collection, contributor, amount, payment_reference):
    ...
    """
    organizer_email = collection.organizer.email  # Adjust based on your model structure
...
Collection Summary:
- Total Contributors: {collection.contributor_set.count()}
- Target Amount: ₦{collection.target_amount}
- Amount Collected: ₦{collection.total_amount_collected()}
    ...
    <html>
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <div style="background-color: #e3f2fd; padding: 15px; border-radius: 5px; margin: 20px 0;">
                ...
                <ul style="list-style: none; padding: 0;">
                    <li><strong>Total Contributors:</strong> {collection.contributor_set.count()}</li>
                    <li><strong>Target Amount:</strong> ₦{collection.target_amount}</li>
                    <li><strong>Amount Collected:</strong> ₦{collection.total_amount_collected()}</li>
                </ul>
            </div>
